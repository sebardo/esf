...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	public function setRol($v)
	{
		...
		if ($this->rol !== $v) {
			$this->rol = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::ROL;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->rol = $rs->getString($startcol + 9);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[9], $arr)) $this->setRol($arr[$keys[9]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserPeer::ROL)) $criteria->add(sfGuardUserPeer::ROL, $this->rol);
