  ...
  <div class="login">
    <div class="login-form">
      <form action="<?php echo url_for('@sf_guard_signin') ?>" method="post">
        <img alt="Login" src="<?php echo sfConfig::get('sf_relative_url_root') ?>/sfAdminDashPlugin/images/login.gif" />
    ...
    <div class="login-text">
      <div class="ctr"><img alt="Security" src="<?php echo sfConfig::get('sf_relative_url_root') ?>/sfAdminDashPlugin/images/login_security.png" /></div>
