...
abstract class BaseCourseI18nPeer {
	...
	const CLASS_DEFAULT = 'lib.model.inscriptions.CourseI18n';
	...
	const SCHEDULE = 'course_i18n.SCHEDULE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Schedule', 'Id', 'Culture', ),
		BasePeer::TYPE_COLNAME => array (CourseI18nPeer::SCHEDULE, CourseI18nPeer::ID, CourseI18nPeer::CULTURE, ),
		BasePeer::TYPE_FIELDNAME => array ('schedule', 'id', 'culture', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Schedule' => 0, 'Id' => 1, 'Culture' => 2, ),
		BasePeer::TYPE_COLNAME => array (CourseI18nPeer::SCHEDULE => 0, CourseI18nPeer::ID => 1, CourseI18nPeer::CULTURE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('schedule' => 0, 'id' => 1, 'culture' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		include_once 'lib/model/inscriptions/map/CourseI18nMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.inscriptions.map.CourseI18nMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CourseI18nPeer::SCHEDULE);
    ...
    foreach (sfMixer::getCallables('BaseCourseI18nPeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
      call_user_func($callable, 'BaseCourseI18nPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseCourseI18nPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseCourseI18nPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseCourseI18nPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseCourseI18nPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseCourseI18nPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseCourseI18nPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseCourseI18nPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseCourseI18nPeer', $values, $con, $ret);
    }
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/inscriptions/map/CourseI18nMapBuilder.php';
	Propel::registerMapBuilder('lib.model.inscriptions.map.CourseI18nMapBuilder');
}
