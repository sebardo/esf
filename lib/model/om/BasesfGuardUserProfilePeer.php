...
abstract class BasesfGuardUserProfilePeer {
	...
	const PASS = 'sf_guard_user_profile.PASS';
	...
	const CULTURE = 'sf_guard_user_profile.CULTURE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Pass', 'Name', 'Email', 'Culture', ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID, sfGuardUserProfilePeer::USER_ID, sfGuardUserProfilePeer::PASS, sfGuardUserProfilePeer::NAME, sfGuardUserProfilePeer::EMAIL, sfGuardUserProfilePeer::CULTURE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'pass', 'name', 'email', 'culture', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Pass' => 2, 'Name' => 3, 'Email' => 4, 'Culture' => 5, ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID => 0, sfGuardUserProfilePeer::USER_ID => 1, sfGuardUserProfilePeer::PASS => 2, sfGuardUserProfilePeer::NAME => 3, sfGuardUserProfilePeer::EMAIL => 4, sfGuardUserProfilePeer::CULTURE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'pass' => 2, 'name' => 3, 'email' => 4, 'culture' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::PASS);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::NAME);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::EMAIL);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::CULTURE);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += sfGuardUserProfilePeer::doOnDeleteCascade(new Criteria(), $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			$c->add(SummerFunCenterHasProfilePeer::PROFILE_ID, $obj->getId());
